...
class CourseClass(models.Model):
    '''
    This model represents each classification ('classification' and 'CourseClass'
    can be considered as synonyms in this context from here onwards)  for all
...
class Course(models.Model):
    ...
    course_class = models.ForeignKey(CourseClass, blank=True, null=True, on_delete=models.SET_NULL, help_text="This field indicates the classification of this course")
    def __str__(self):
        return self.name
